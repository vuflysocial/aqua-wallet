    ...
    <div className="AccountTransactions">
        ...
        <table className="table table-striped overflow-auto">
            ...
            {transactions.map(transaction => (
                ...
                <td>
                    <a
                    href={`${binance.blockExplorerUrl}/tx/${transaction.hash}`}
                    target="_blank"
                ...
                <td>
                    <a
                    href={`${binance.blockExplorerUrl}/address/${transaction.from_address}`}
                    target="_blank"
                    rel="noopener noreferrer"
                    >
                ...
                <td>
                    <a
                    href={`${binance.blockExplorerUrl}/address/${transaction.to_address}`}
                    target="_blank"
                    rel="noopener noreferrer"
                    >
